...
func ensureManagedLocalBroker(ctx context.Context, profile internalconfig.LocalProfile, region internalconfig.ProfileRegion) (*managedLocalBroker, error) {
	_ = ctx
...
func clearGlobalProfileRegion(regions []internalconfig.ProfileRegion, region string) []internalconfig.ProfileRegion {
	region = strings.TrimSpace(region)
	if region == "" {
		return nil
	}
	var out []internalconfig.ProfileRegion
